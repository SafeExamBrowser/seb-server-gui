...
export type GuiAbilities = {
    components: Array<'INSTITUTIONS' | 'EDIT_INSTITUTION' | 'CREATE_INSTITUTION' | 'NAVIGATION_OVERVIEW' | 'HOME' | 'SETTINGS' | 'USER_ACCOUNTS' | 'CONNECTION_CONFIGS' | 'LMS_SETUPS' | 'CERTIFICATES' | 'EXAM_TEMPLATE' | 'PREPARE_EXAM' | 'ADD_EXAM_WITH_URL' | 'EXAMS' | 'RUNNING_EXAMS' | 'SCREEN_PROCTORING' | 'SCREEN_PROCTORING_SEARCH' | 'SCREEN_PROCTORING_APPLICATION_SEARCH' | 'ANALYZE_EXAMS' | 'ARCHIVE_EXAMS' | 'SCHEDULED_DELETION'>;
