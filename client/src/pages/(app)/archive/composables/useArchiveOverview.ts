...
import { useMultiRowSelection } from "@/components/widgets/entity-table/composables/useMultiRowSelection.ts";
import { useMultiSelectionFlow } from "@/components/widgets/entity-table/composables/useMultiSelectionFlow.ts";
import { TableItem } from "@/components/widgets/entity-table/types.ts";
import { SearchBarAction } from "@/components/widgets/searches/types.ts";
import { Exam } from "@/models/seb-server/exam.ts";
import { ExamStatusEnum } from "@/models/seb-server/examFiltersEnum.ts";
import { useDoArchiveExams } from "@/pages/(app)/archive/api/useDoArchiveExams.ts";
import { useArchiveList } from "@/pages/(app)/archive/composables/useArchiveList.ts";
import { useArchiveTableActions } from "@/pages/(app)/archive/composables/useArchiveTableAdditions.ts";
...
export const useArchiveOverview = () => {
    ...
    // add Exclude from Deletion header
    headers.value.push({
        title: translate(`examDetail.sidePanel.actions.excludedFromDeletion`),
