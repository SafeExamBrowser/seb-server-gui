...
export async function getConnectionConfigurationsActive(isActive: string): Promise<any>{
...
export async function getConnectionConfiguration(id: number): Promise<ConnectionConfiguration | any>{
...
export async function getConnectionConfigurations(optionalParameters?: OptionalParGetConnectionConfiguration): Promise<ConnectionConfigurations | any>{
...
export async function activateConnectionConfiguration(id: string): Promise<ConnectionConfiguration | any> {
...
export async function deactivateConnectionConfiguration(id: string): Promise<ConnectionConfiguration | any> {
...
export async function deleteConnectionConfiguration(id: string): Promise<any | any> {
    return (await apiService.api.delete(connectionConfigurationUrl + "/" + id, {headers: apiService.getHeaders(StorageItemEnum.ACCESS_TOKEN)})).data;
