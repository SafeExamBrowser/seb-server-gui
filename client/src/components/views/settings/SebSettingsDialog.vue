...
<script setup lang="ts">
    import SebSettingsApplications from "@/components/views/settings/SebSettingsApplications.vue";
    import SebSettingsNetwork from "@/components/views/settings/SebSettingsNetwork.vue";
