...
import { useTable } from "@/components/views/seb-server/exam-template/wizard/components/stepIndicators/composables/useTable";
import { Indicator } from "@/components/views/seb-server/exam-template/wizard/components/stepIndicators/types";
