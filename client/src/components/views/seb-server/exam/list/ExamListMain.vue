...
const examsTableHeaders = ref([
    ...
    {
        title: translate("examList.main.tableHeaderStart"),
        key: "quizStartTime",
        width: "20%",
    },
    {
        title: translate("examList.main.tableHeaderEnd"),
        key: "quizEndTime",
        width: "20%",
    },
    {
        title: translate("examList.main.tableHeaderType"),
        key: "type",
        sortable: false,
        width: "12.5%",
    },
    {
        title: translate("examList.main.tableHeaderStatus"),
        key: "status",
        sortable: false,
        width: "12.5%",
    },
